...
Page({
  ...
  getData: function() {
    ...
    for (const key in data.orderPriceCountRespVo) {
      data.orderPriceCountRespVo[key] = this.filterMoney(
        data.orderPriceCountRespVo[key]
      );
    }
    for (const key in data.shopPersonInfoRespVo) {
      data.shopPersonInfoRespVo[key] = this.filterMoney(
        data.shopPersonInfoRespVo[key]
      );
    }
    this.setData(
      {
